...
VALUES
    ...
    (14, 'Sala 3', 'images/room3.png', 'Salka konferncyjna o powierzchni 35 m2 to przeszklone pomieszczenie, stanowiące idealne tło niewielkich spotkań biznesowych, rozmów kwalifikacyjnych, jak i szkoleń w małych grupach. Sala jest klimatyzowana, posiada rzutnik, flipchart oraz wi-fi. W stałym układzie kameralnym, pomieści 14 osób.'),
    (50, 'Sala 4', 'images/room4.png', 'Duża sala wykładowa o powierzchni 90m2 z pojedynczymi ławkami dla uczestników, standardowo wyposażona w rzutnik z ekranem, tablicę suchościeralną, flipchart, klimatyzację oraz wi-fi. Ławki i krzesła w sali łatwo jest w razie potrzeby przestawić, aby jak najlepiej dostosować salę do potrzeb szkolenia.'),
    (40, 'Sala 5', 'images/room5.png', 'Jasna, przestronna sala o powierzchni 45m, mieszcząca do 40 osób, wyposażona w rzutnik z ekranem oraz flipchart, które ułatwią przeprowadzenie skutecznego szkolenia. Przeznaczona jest do spotkań szkoleniowych lub konferencji, oświetlona światłem naturalnym, z możliwością wybrania jednego spośród wielu ustawień, co pozwoli dostować układ krzeseł tak, by uczestnicy czerpali ze szkolenia jak najwięcej.');
